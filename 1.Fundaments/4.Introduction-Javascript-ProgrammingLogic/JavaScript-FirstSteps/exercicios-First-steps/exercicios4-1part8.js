...
console.log('valor atribuido apoś aplicar 27,5% :', desconto);
  desconto = desconto - 869.36;
console.log('Desconto :', desconto);
console.log('seu salário líquido é de: ', salarioBase - desconto);
};