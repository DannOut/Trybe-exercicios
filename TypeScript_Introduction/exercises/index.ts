...
console.log(
  `- Losango de base maior 32cm e base menor 18cm: ${Ex.getDiamondArea(
    32,
    18
  )}cm²`
);
console.log(
  `- Losango de base maior 200cm e base menor 50cm: ${Ex.getDiamondArea(
    200,
    50
  )}cm²`
);
console.log(
  `- Losango de base maior 75cm e base menor 25cm: ${Ex.getDiamondArea(
    75,
    25
  )}cm²`
);
...
console.log(
  `Trapézio de base maior 100cm, base menor 70cm e altura 50cm: ${Ex.getTrapezeArea(
    100,
    70,
    50
  )}cm²`
...
console.log(
  `Trapézio de base maior 75cm, base menor 50cm e altura 35cm: ${Ex.getTrapezeArea(
    75,
    50,
    35
  )}cm²`
...
console.log(
  `Trapézio de base maior 150cm, base menor 120cm e altura 80cm: ${Ex.getTrapezeArea(
    150,
    120,
    80
  )}cm²`
